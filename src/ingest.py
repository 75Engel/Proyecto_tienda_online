...
df_product=pd.read_csv(r'src\Data\productos_240329.csv')
df_users=pd.read_csv(r'src\Data\usuarios_240329.csv')
df_tag=pd.read_csv(r'src\Data\tags_240329.csv')
df_prices=pd.read_csv(r'src\Data\precios_240329.csv')
df_comments=pd.read_csv(r'src\Data\comentarios_240329.csv')
...
df_tag_new=df_tag_new[nombre_listas]
